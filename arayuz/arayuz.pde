...
void setup() {
    ...
    // Serial serial = new Serial(this, "!!INSERT PORT HERE!!", 19200);
    // sender = new ValueSender(this, serial).observe("abortte");
    // receiver = new ValueReceiver(this, serial).observe("packageNo").observe("rssiValue").observe("snrValue");
}
...
void draw() {
    ...
    text("rssiValue: " + packageNo, 5, 60);
    text("packageNo: " + packageNo, 5, 90);
